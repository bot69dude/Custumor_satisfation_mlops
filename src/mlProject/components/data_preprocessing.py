...
class DataPreprocessing:
    ...
    def _read_data(self):
        try:
            ...
            logger.error(f"Error occurred while reading data: {str(e)}")
            raise e
    ...
    def _calculate_delivery_time(self):
        try:
            ...
            logger.error(f"Error occurred while calculating delivery time: {str(e)}")
            raise e
    ...
    def _calculate_delivery_delay(self):
        try:
            ...
            logger.error(f"Error occurred while calculating delivery delay: {str(e)}")
            raise e
    ...
    def _scale_data(self):
        try:
            ...
            review_score = self.df['delivery_delay'].values.reshape(-1, 1)
            ...
            self.df['delivery_delay'] = scaled_review_score
        except Exception as e:
            logger.error(f"Error occurred while scaling data: {str(e)}")
            raise e
    ...
    def _encode_categorical_data(self):
        try:
            ...
            logger.error(f"Error occurred while encoding categorical data: {str(e)}")
            raise e
    
    def _drop_columns(self):
        try:
            self.df = self.df.drop(columns=self.config.drop_params)
        except Exception as e:
            logger.error(f"Error occurred while dropping columns: {str(e)}")
            raise e
    ...
    def _save_preprocessed_data(self):
        try:
            ...
            logger.error(f"Error occurred while saving preprocessed data: {str(e)}")
            raise e
